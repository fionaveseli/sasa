        ...
        <section className="py-10">
          <div className="flex flex-col md:flex-row max-w-screen gap-2 justify-between">
            ...
            <p className="min-w-[45%] text-p font-extralight">
              Explore the key features that make tournament management seamless.
              From joining teams and adding universities to receiving real-time
              notifications, everything you need is in one place.
            </p>
          </div>
